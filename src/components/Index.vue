<template>
  <div class="index">
    ...
    <div class="nav">
      <ul>
        ...
        <li>
          ...
          />
          <p @click="$router.push('/oto')">一对一辅导</p>
        </li>
        <li>
          <img
    ...
    <div class="list" >
      <!-- 名师阵容 -->
      <div class="famous"  v-for="(item, index) in data" :key="index" v-show="item.channel_info.id==19">
        <div class="list_title" >
          <p class="red_title"></p>
          <span>{{ item.channel_info.name }}</span>
        </div>
        <ul>
          <li @click="toTeacher(i)" v-for="(i, k) in item.list" :key="k">
      ...
      <!-- 精品课程 -->
      <div class="excellent_course" v-for="(item, index) in data" :key="index" v-if="item.channel_info.id==15">
        <div class="list_title">
          <p class="red_title"></p>
          <span>{{ item.channel_info.name}}</span>
        </div>
        <ul>
          <li @click="toDetail(i)" v-for="(i, k) in item.list" :key="k">
            <p>
              {{ i.title }}
            </p>
      ...
      <div class="excellent_course" v-for="(item, index) in data" :key="index" v-if="item.channel_info.id==18">
        <div class="list_title">
          <p class="red_title"></p>
          <span>{{ item.channel_info.name}}</span>
        </div>
      ...
      <!-- 明星讲师 -->
      <div class="mingxing" v-for="(item, index) in data" :key="index" v-show="item.channel_info.id==14">
        <div class="list_title">
          <p class="red_title"></p>
          <span>明星讲师</span>
        </div>
